...
urlpatterns = [
    ...
    path('despesas/nova-interface/', views.expenses_dashboard_new, name='expenses_new'),
    path('despesas/simplificada/', views.expenses_dashboard_simple, name='expenses_simple'),
    path('despesas/chart-data/', views.expense_chart_data, name='expense_chart_data'),
    ...
    path('despesas/alternar-status/<int:expense_id>/', views.toggle_expense_payment, name='toggle_expense_payment'),
    ...
    # Adicionando rota de verificação de autenticação
