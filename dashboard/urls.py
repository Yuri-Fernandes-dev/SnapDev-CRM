...
urlpatterns = [
    ...
    path('despesas/', views.expenses_dashboard_simple, name='expenses'),
    path('despesas/completa/', views.expenses_dashboard, name='expenses_dashboard'),
    path('despesas/simples/', views.expenses_dashboard_simple, name='expenses_dashboard_simple'),
